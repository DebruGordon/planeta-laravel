    ...
    <div>
      ...
      <main>
        <section class="body-section">
          ...
          <form class="form-group" action="" method="POST" enctype= "multipart/form-data"> <!-- la class form-group es de bootstrap -->


            <div class="campos"> <!-- cambiar la class fondo-campo, botones-login, id recordarme y id button por botones de bootstrap -->
